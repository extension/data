class ConsistentifyTables < ActiveRecord::Migration
  def change
    # NOTE! does not include the "analytics table" - because I didn't want to recreate that data!
    ...
    ## calculated tables that we really want to be consistent
